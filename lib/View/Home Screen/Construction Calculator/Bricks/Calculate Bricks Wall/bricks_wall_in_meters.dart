...
class _BricksDimensionsInMetersState extends State<BricksDimensionsInMeters> {
  ...
  void initState(){
    ...
    bricksController.getLengthInBrickDimensionMeters(double.tryParse('190'));
    bricksController.getWidthInBrickDimensionMeters(double.tryParse('90'));
    bricksController.getThicknessInBrickDimensionMeters(double.tryParse('9'));
