  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Obx(() => ResultsRow(
              title: 'Brick Cost',
              result: '${bricksController.bricksCost.value.toStringAsFixed(0)} Amount',
            )),
        Obx(() => ResultsRow(
              title: 'Cement Bags',
              result: feetScreen
                  ? '${bricksController.totalCementBagsFeet.value
                  .toStringAsFixed(3)} Bags'
                  : '${bricksController.totalCementBagsMeters.value
                  .toStringAsFixed(3)} Bags',
            )),
        Obx(() => ResultsRow(
              title: 'Cement Cost',
        ...
        Obx(
          () => ResultsRow(
            ...
            result: feetScreen
                ? '${bricksController.totalNumberOfBricksFeet.value
                .toStringAsFixed(3)} Bricks'
                : '${bricksController.totalNumberOfBricksMeters.value
                .toStringAsFixed(3)} Bricks',
          ),
        )
      ],
