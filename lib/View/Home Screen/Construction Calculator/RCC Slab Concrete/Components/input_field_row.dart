...
class InputFieldRowRccSlabsConcrete extends StatelessWidget {
  const InputFieldRowRccSlabsConcrete({
    super.key,
    ...
    this.wantTitle = true, this.changePaddingOnLeft=false, this.newPadding,
  });
  ...
  final bool changePaddingOnLeft;
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Padding(
        padding: EdgeInsets.only(left:changePaddingOnLeft?newPadding!:screenWidth * 0.05),
        child: Row(
