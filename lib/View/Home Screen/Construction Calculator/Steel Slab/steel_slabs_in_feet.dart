...
class SlabSteelDimensionsInFeet extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SectionOneSlabSteel(feetScreen: true,),
                SizedBox(
                ...
                const SectionTwoSlabSteel(feetScreen: true,),
                SizedBox(
                  height: screenHeight * 0.03,
                ),
                const ResultSectionSlabSteel(feetScreen: true,),
              ],
            ),
          ),
        ),
