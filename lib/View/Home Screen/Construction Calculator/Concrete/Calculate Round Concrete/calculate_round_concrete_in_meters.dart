...
class RoundConcreteQuantityInMeters extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SectionTwoRoundConcrete(feetScreen: false,),
                SizedBox(
                  height: screenHeight * 0.03,
                ),
                const ResultSectionRoundConcrete(feetScreen: false,),
              ],
            ),
          ),
        ),
