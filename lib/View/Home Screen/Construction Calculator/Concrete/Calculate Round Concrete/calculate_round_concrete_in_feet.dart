...
class RoundConcreteQuantityInFeet extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SectionTwoRoundConcrete(feetScreen: true,),
                SizedBox(
                  height: screenHeight * 0.03,
                ),
                const ResultSectionRoundConcrete(feetScreen: true,),
              ],
            ),
          ),
        ),
