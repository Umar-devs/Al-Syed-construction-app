...
class BlocksDimensionsInMeters extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SectionOneBlocks(feetScreen: false,),
                SizedBox(
                ...
                const SectionTwoBlocks(feetScreen: false,),
                SizedBox(
                  height: screenHeight * 0.03,
                ),
                const ResultSectionBlocks(feetScreen: false,),
              ],
            ),
          ),
        ),
