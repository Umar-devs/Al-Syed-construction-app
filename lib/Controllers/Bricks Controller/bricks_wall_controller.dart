...
class BricksController extends GetxController {
  ...
  static final RxDouble lengthInBrickDimensionFeet = 0.0.obs;
  static final RxDouble lengthInBrickDimensionMeters = 0.0.obs;
  static final RxDouble widthInBrickDimensionFeet = 0.0.obs;
  static final RxDouble widthInBrickDimensionMeters = 0.0.obs;
  static final RxDouble thickInInchesInBrickDimension = 0.0.obs;
  static final RxDouble thickInMMInBrickDimension = 0.0.obs;
